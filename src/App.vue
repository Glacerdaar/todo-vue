...
<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <input :value="estado.tarefaTempo" @change="evento => estado.tarefaTempo = evento.target.value" required type="text" placeholder="Digite aqui a descriçao da tarefa" class="form-control">
      </div>
      <div class="col-md-2">
